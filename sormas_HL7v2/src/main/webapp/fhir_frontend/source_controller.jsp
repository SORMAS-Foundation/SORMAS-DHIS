                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-12 connectedSortable">
                            ...
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <ul class="todo-list" data-widget="todo-list" id="productTa">
           ...
           <script type="text/javascript">
            ...
            <script type="text/javascript">
                ...
                function tableListSuccess(tables) {
                 //   console.log(tables);
                    // Iterate over the collection of data
                    // $.each($.parseJSON(tables), function (index, value) {
                    // Add a row to the Product table
                    // console.log(value.getOwnPropertyNames());
                ...
                function tableAddRow(table) {
                    ...
                    // console.log(table.prototype.URL);
            ...
            <script type="text/javascript">
//populates the sources to be paired
                function table_List() {
                  //  console.log("in source lists");
                    $.ajax({
                        url: '../controller?getAllList=0',
             ...
             //       console.log(table_s);
                    // Iterate over the collection of data
                    // $.each($.parseJSON(table_s), function (index, value) {
                    // Add a row to the Product table_
                    // console.log(value.getOwnPropertyNames());
                ...
                function table_AddRow(table_) {
                    ...
                    //  table_ = $.parseJSON(table_);
                    // console.log(table_.prototype.URL);
